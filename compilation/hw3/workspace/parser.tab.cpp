...
{
       0,    84,    84,   128,   136,   137,   140,   139,   192,   193,
     195,   196,   198,   203,   213,   220,   221,   223,   228,   229,
     231,   244,   259,   288,   308,   311,   322,   350,   359,   367,
     368,   369,   371,   371,   378,   384,   384,   392,   399,   406,
     411,   418,   461,   496,   497,   507,   508,   509,   512,   513,
     516,   519,   522,   525,   535,   539,   543,   546,   550,   554,
     558,   561,   564,   567,   570
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STRING", "AND", "OR", "ASSIGN", "RELOP_EQ", "RELOP", "PLUS", "MINUS",
  "MULT", "DIV", "NOT", "LPAREN", "RPAREN", "$accept", "program", "M1",
  "funcs", "funcdecl", "$@1", "retype", "formals", "formalslist",
  "formaldecl", "preconditions", "precondition", "statements", "statement",
  "IF_SCOPE", "$@2", "M_IF_SCOPE", "WHILE_SCOPE", "$@3", "M_WHILE_SCOPE",
  "ELSE_SCOPE", "M_ELSE_SCOPE", "N", "call", "explist", "type", "exp", YY_NULLPTR
};
#endif
...
{
     -34,    11,    37,   -34,   -34,   -34,   -34,   -34,     9,    37,
      -8,   -34,   -34,   -34,   -14,    67,   -34,   -34,     6,     4,
      -3,    67,   -34,   -34,   -34,   -13,    10,   119,   -34,    46,
       0,    30,    33,   -22,    81,   -34,    35,    39,   -34,    43,
      38,    55,    60,   -34,   -34,    52,    83,   -34,    46,    46,
     -34,   160,   -34,   118,   -34,   -34,    46,    -7,   -34,   -34,
     -34,   -34,    57,    58,   119,   -34,   -15,   -34,   -34,   169,
      46,    46,    46,    46,    46,    46,    46,    46,   -34,   -34,
     127,   -34,    54,   151,   119,    46,    46,   100,   -34,    46,
     -34,   186,   192,   198,   142,    -1,    -1,   -34,   -34,   -34,
     -34,    46,   -34,   178,   178,   -34,   136,   -34,    62,    63,
     -34,   119,   119,   -34,   -34
};
...
{
       3,     0,     5,     1,     9,    45,    46,    47,     0,     5,
       0,     8,     2,     4,     0,    11,     6,    10,    12,     0,
       0,     0,    14,    16,    13,     0,     0,    34,    15,     0,
       0,     0,     0,     0,    34,    18,    29,     0,    31,     0,
       0,     0,     0,    58,    59,    53,    55,    57,     0,     0,
      54,     0,    25,     0,    27,    28,     0,     0,     7,    19,
      39,    30,     0,     0,    34,    24,     0,    56,    60,     0,
       0,     0,     0,     0,     0,     0,     0,     0,    17,    26,
       0,    42,     0,    43,    34,     0,     0,    34,    21,     0,
      48,    61,    62,    63,    64,    49,    50,    51,    52,    23,
      41,     0,    38,    32,    35,    20,     0,    44,     0,     0,
      22,    34,    34,    33,    36
};
...
{
     -34,   -34,   -34,    86,   -34,   -34,   -34,   -34,    80,   -34,
     -34,   -34,    45,   -33,   -34,   -34,   -34,   -34,   -34,   -34,
     -34,   -34,   -34,   -27,    12,    29,    -9
};
...
{
      -1,     1,     2,     8,     9,    20,    10,    16,    17,    18,
      25,    28,    34,    35,    36,   108,    37,    38,   109,    39,
      31,    32,    33,    34,    26,    27,    37,    29,    30,    31,
      32,    33,    34,    27,    -1,    29,    30,    31,    32,    33,
...
static const yytype_uint8 yystos[] =
{
      ...
      44,    63,     3,    41,    23,    36,    45,    46,    47,    63,
      43,    20,    23,    37,    46,    48,    18,    21,    49,    36,
      11,    16,    17,    23,    50,    51,    52,    54,    55,    57,
      60,    61,    63,     9,    10,    23,    24,    25,    35,    36,
      61,    64,    19,    64,    19,    19,    28,    36,    22,    51,
      13,    58,    14,    15,    21,    19,    23,     7,    64,    64,
      26,    27,    29,    30,    31,    32,    33,    34,    37,    19,
      64,    37,    62,    64,    59,    36,    36,    50,    19,    28,
      37,    64,    64,    64,    64,    64,    64,    64,    64,    19,
      37,    20,    51,    64,    64,    22,    64,    62,    53,    56,
      19,    37,    37,    51,    51
};
...
{
       0,    38,    39,    40,    41,    41,    43,    42,    44,    44,
      45,    45,    46,    46,    47,    48,    48,    49,    50,    50,
      51,    51,    51,    51,    51,    51,    51,    51,    51,    51,
      51,    51,    53,    52,    54,    56,    55,    57,    58,    59,
...
#line 172 "parser.ypp" /* yacc.c:1646  */
    {	
			...
			endScope();
			printPreconditions((yyvsp[-8])->value, preCondCounter);
...
#line 288 "parser.ypp" /* yacc.c:1646  */
    {
					...
					if (!symbolTable.checkIfVariableExists((yyvsp[-3])->names[0])){
						errorUndef(yylineno, (yyvsp[-2])->names[0]);
						exit(1);
					}
...
#line 419 "parser.ypp" /* yacc.c:1646  */
    {
		...
		std::vector<string> v_args = symbolTable.getFunctionArgs((yyvsp[-3])->names[0]);

        vector<string> v_args_s = argsTypesToStr(symbolTable.getFunctionArgs((yyvsp[-3])->names[0]));
		//check all arguments
		if ((yyvsp[-1])->types.size() != v_args.size()){
			// error
			errorPrototypeMismatch(yylineno, (yyvsp[-3])->value, v_args_s);
			exit(1);
		}
...
#line 462 "parser.ypp" /* yacc.c:1646  */
    {
		...
		if (!symbolTable.checkIfFunctionExists((yyvsp[-2])->names[0])){
			errorUndefFunc(yylineno, (yyvsp[-2])->names[0]);
			exit(1);
		}

		
		string rettype = symbolTable.getFunctionRetType((yyvsp[-2])->names[0]);
		std::vector<string> args = symbolTable.getFunctionArgs((yyvsp[-2])->names[0]);

		vector<string> args_s = argsTypesToStr(symbolTable.getFunctionArgs((yyvsp[-2])->names[0]));
		//check all arguments
		if (args.size() != 0){
			// error
			errorPrototypeMismatch(yylineno, (yyvsp[-2])->value, args_s);
			exit(1);
		}
...
#line 497 "parser.ypp" /* yacc.c:1646  */
    {
			...
			(yyval)->line_num = (yyvsp[-2])->line_num;
		}
...
#line 561 "parser.ypp" /* yacc.c:1646  */
    {
		(yyval) = new BoolOp((yyvsp[-2]), (yyvsp[0]), (yyvsp[-1])->value, yylineno);
	}
...
#line 575 "parser.ypp" /* yacc.c:1906  */
